    ...
    createRoutesFromChildren(
        <Route element={<MainLayout />}>
            ...
            <Route element={<WithAuthContext />}>
                ...
                />
                <Route lazy={() => import("./settings").then(module => ({ Component: module.default }))}>
                    <Route
                        path = {PATHS.SETTINGS.PROFILE}
                        lazy={() => import("./settings/profile").then(module => ({ Component: module.default }))}
                    />
                    <Route
                        path = {PATHS.SETTINGS.TRAVELERS}
                        lazy={() => import("./settings/travellers").then(module => ({ Component: module.default }))}
                    />
                    <Route
                        path = {PATHS.SETTINGS.BOOKING_HISTORY}
                        lazy={() => import("./settings/booking-history").then(module => ({ Component: module.default }))}
                    />
                </Route>
            </Route>
            <Route
